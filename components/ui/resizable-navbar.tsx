    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        width: visible ? "60%" : "100%", // Less aggressive size change
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
      ...
      style={{
        minWidth: visible ? "600px" : "auto", // Responsive min-width
      }}
      className={cn(
    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ? "0 0 24px rgba(34, 42, 53, 0.06), 0 1px 1px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(34, 42, 53, 0.04), 0 0 4px rgba(34, 42, 53, 0.08), 0 16px 68px rgba(47, 48, 55, 0.05), 0 1px 0 rgba(255, 255, 255, 0.1) inset"
          : "none",
        // Keep consistent sizing on mobile - no width changes
        width: "100%",
        paddingRight: "16px",
        paddingLeft: "16px",
        borderRadius: "0px", // Keep consistent border radius for sticky behavior
        y: 0, // No vertical offset for sticky navbar
      }}
      transition={{
        type: "spring",
        stiffness: 200,
      ...
      className={cn(
        ...
        // Always show background on mobile for better visibility when sticky
