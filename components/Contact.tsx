    ...
    <GridSection className="flex flex-col lg:flex-row w-full" id="engagement">
      ...
      <div className="flex flex-col gap-6 px-8 lg:px-12 py-16 lg:py-24 border-b lg:border-b-0 lg:border-r border-dashed border-neutral-800/80 justify-center h-full">
        ...
        <p className="text-base text-neutral-400 max-w-md leading-relaxed">
          Currently taking on select engineering engagements and strategic consulting for early-stage founders and product teams. Let&apos;s discuss your architecture.
        </p>
      </div>
      </Reveal>
          ...
          {isSubmitted ? (
            <div className="flex flex-col space-y-4 animate-in fade-in duration-500">
              ...
              <p className="text-sm text-neutral-400 leading-relaxed font-sans">
                I&apos;ve received your details and will follow up with a direct calendar link to schedule a call within the next 12 hours.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
              ...
              >
                {isSubmitting ? "Processing architecture details..." : (
                  <>Book Discovery Call <span className="inline-block transition-transform duration-75 ease-out group-hover:translate-x-1">→</span></>
                )}
              </Button>
            </form>
          )}
