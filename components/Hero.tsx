...
import { HeroCodeDemo } from "./HeroCodeDemo";
...
export function Hero() {
  return (
    <GridSection className="relative flex flex-col w-full overflow-hidden">
      <div className="relative px-8 lg:px-12 py-20 lg:py-28 flex flex-col lg:flex-row justify-between items-start w-full">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start w-full">
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <FadeUp delay={0.04}>
              <h1 className="text-4xl lg:text-5xl xl:text-[3.25rem] font-medium text-white tracking-tight leading-[1.08] max-w-3xl">
            ...
            <FadeUp delay={0.1}>
              <div className="flex flex-col gap-3 max-w-xl">
                ...
                <p className="text-base text-neutral-400 font-normal leading-relaxed">
                  I&apos;m Anindo, a {siteConfig.person.role.toLowerCase()}{" "}
                  helping founders ship{" "}
                  {siteConfig.person.specialization.toLowerCase()} from{" "}
                  {siteConfig.person.homeLocation.country}, worldwide.
                </p>
              </div>
            </FadeUp>
